...
const Hero = () => {
  return (
    ...
    px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      relative font-bold text-gray-800 max-w-3xl mx-auto'>Choose from our expertly designed
        Courses to unlock your potential.
        <samp className='text-blue-600'>fit your choice</samp>
