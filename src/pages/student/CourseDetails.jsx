...
const CourseDetails = () => {
  ...
  useEffect(() => {
    fetchCourseData();
  }, [id, allCourses]); // Include id as a dependency
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
              ...
              {courseData.courseContent.map((chapter, index) => (
                <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                  ...
                  <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'}`}>
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-r border-gray-300">
                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                            ...
                            <div className="flex gap-2">
                              {lecture.isPreviewFree && (
                                <p
                                  onClick={() => setVideoId(lecture.lectureUrl)}
        ...
        {/* Right column: Pricing, Media, and Enrollment */}
